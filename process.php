...
if ($pid == -1) {
    ...
    sleep(5);
    echo 'I am child process1. My PID is ' . $mypid . " and my father's PID is " . $parentPid . PHP_EOL;
} else {
    ...
    if ($pid == -1) {
        ...
        $mypid = getmypid(); // 用getmypid()函数获取当前进程的PID
        sleep(5);
        echo 'I am child process2. My PID is ' . $mypid . " and my father's PID is " . $parentPid . PHP_EOL;
    } else {
        echo "Oh my god! I am a father now! My child's PID is " . $pid . ' and mine is ' . $parentPid . PHP_EOL;
    }
}
